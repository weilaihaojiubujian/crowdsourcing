			...
			<div class="container-fuild">
				...
				<div class="row">
					<section class="col-md-12 userTable">
						<section>
							<h2>提现</h2>
							<form action="/transfer/withdrawal" method="post" class="form-horizontal">
								<div class="form-group">
									<label for="price" class="col-sm-2 control-label">提现</label>
									<div class="col-sm-10">
								...
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-10">
										<input type="submit" class="btn btn-default" value="提现">
									</div>
								</div>
							</form>
						</section>
...
<!-- <form action="/transfer/withdrawal" method="post">
