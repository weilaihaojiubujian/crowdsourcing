...
<div class="container-fuild page">
  ...
  <div class="row">
    <main role="main" class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1">
      <div class="container-fuild">
        ...
        <div class="row">
          <section class="col-md-12 userTable">
            <section>
              <h2>注册商家信息</h2>
              <form method="post" action="/user/registbusinessinformation"  class="form-horizontal">
                ...
                <div class="form-group">
                  <label for="headidcard" class="col-sm-2 control-label">负责人身份证号</label>
                  <div class="col-sm-10">
                    <input type="text"  name="headidcard" id="headidcard" class="form-control">
                  </div>
                </div>
                <div class="form-group">
