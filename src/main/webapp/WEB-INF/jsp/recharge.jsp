		  	  ...
		  	  <aside role="complementary" class="asideNav hidden-xs hidden-sm hideAside">
		  	  	<div class="sideNav">
		  	  		<ul>
		  	  			...
		  	  			<li>
		  					<div class="liItems">
		  	  					<div><i class="icon-minus-sign"></i></div><div><a href="/task/releasebyuser?pageNum=1">查看任务</a></div>
		  	  				</div>
		  	  			</li>
		  	  			<li>
		  					<div class="liItems">
		  	  					<div><i class="icon-minus-sign"></i></div><div><a href="/bankaccount/bankaccount?pageNum=1">查看银行卡</a></div>
		  	  				</div>
		  	  			</li>
		  	  			<li>
		  					<div class="liItems">
		  	  					<div><i class="icon-minus-sign"></i></div><div><a href="/transfer/view?pageNum=1">查看转账记录</a></div>
		  	  				</div>
		  	  			</li>
		  	  			<li>
		  					<div class="liItems">
		  	  					<div><i class="icon-minus-sign"></i></div><div><a href="/transfer/recharge1">充值</a></div>
		  	  				</div>
		  	  			</li>
		  	  			<li>
		  					<div class="liItems">
		  	  					<div><i class="icon-minus-sign"></i></div><div><a href="/transfer/withdrawal1">提现</a></div>
		  	  				</div>
		  	  			</li>
		  	  		</ul>
		  	  	</div>
		  	  ...
		  	  <main role="main" class="col-md-8 col-md-offset-3 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1">
		  	  	<div class="container-fuild">
		  	  		<div class="row">
		  				...
		  				<section>
		  				    <h2>充值</h2>
		  					<form action="/transfer/recharge" method="post" class="form-horizontal">
		  					    ...
		  					    <div class="form-group">
		  					      <div class="col-sm-offset-2 col-sm-10">
									  <input type="submit" class="btn btn-default" value="充值">
		  					      </div>
		  					    </div>
		  					</form>
		  				</section>
...
<!-- <form action="/transfer/recharge" method="post">
